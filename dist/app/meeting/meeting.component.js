System.register(['angular2/core', 'angular2/common', 'angular2/router', './meeting.service', '../currency/currency.service', '../currency/currency', './meeting-status.component', '../common/toggle.component', '../common/location-finder.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, router_1, meeting_service_1, currency_service_1, currency_1, meeting_status_component_1, toggle_component_1, location_finder_component_1;
    ...
    return {
        setters:[
            ...
            function (location_finder_component_1_1) {
                location_finder_component_1 = location_finder_component_1_1;
            }],
        execute: function() {
            MeetingComponent = (function () {
                ...
                MeetingComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [common_1.CORE_DIRECTIVES, common_1.FORM_DIRECTIVES, meeting_status_component_1.MeetingStatusComponent, toggle_component_1.ToggleComponent, location_finder_component_1.LocationFinderComponent]
                    }), 
