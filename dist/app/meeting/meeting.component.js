System.register(['angular2/core', 'angular2/common', './meeting-status.component', './meeting.service', '../currency/currency.service', '../currency/currency'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, meeting_status_component_1, meeting_service_1, currency_service_1, currency_1;
    ...
    return {
        ...
        execute: function() {
            MeetingComponent = (function () {
                function MeetingComponent(meetingService, currencyService) {
                ...
                MeetingComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [meeting_service_1.MeetingService, currency_service_1.CurrencyService])
                ], MeetingComponent);
